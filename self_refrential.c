...
void display_menu() {
    ...
    printf("Enter 6 to delete last node\n");
    printf("Enter 7 to delete a node after given node\n");
    printf("Enter 8 to delete a node at specific position\n");
    printf("Enter 9 to traverse\n");
    printf("Enter 10 delete all nodes \n");
